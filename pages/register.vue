<template>
  <div class="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 py-16">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <div class="flex items-start">
              ...
              <label for="terms" class="ml-2 text-sm text-gray-700">
                ฉันยอมรับ
                <NuxtLink to="/terms" class="text-primary-500 hover:text-primary-600">เงื่อนไขการใช้งาน</NuxtLink>
                และ
                <NuxtLink to="/privacy" class="text-primary-500 hover:text-primary-600">นโยบายความเป็นส่วนตัว</NuxtLink>
              </label>
            </div>
