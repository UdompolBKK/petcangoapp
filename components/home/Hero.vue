      ...
      <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          <form @submit.prevent="handleSearch" class="space-y-4">
            ...
            <button
              type="submit"
              class="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-4 px-8 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
            >
